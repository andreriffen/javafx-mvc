...
import andreriffen.javafxmvc.model.dao.ItemDeVendaDAO;
import andreriffen.javafxmvc.model.dao.ProdutoDAO;
...
import andreriffen.javafxmvc.model.domain.ItemDeVenda;
import andreriffen.javafxmvc.model.domain.Produto;
import andreriffen.javafxmvc.model.domain.Venda;
...
public class FXMLAnchorPaneProcessosVendasController implements Initializable {
    ...
    public void carregarTableViewVendas() {
        ...
        listVendas = new ArrayList<>(); // Adicionei esta linha para evitar erro de null pointer
...
//        loader.setLocation(FXMLAnchorPaneProcessosVendasDialogController.class.getResource("/andreriffen/javafxmvc/FXMLAnchorPaneProcessosVendasDialog.fxml"));
